...
export const LiquidBackground = () => {
  return (
    <>
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-[-20%] left-[-20%] md:top-[-10%] md:left-[-10%] w-[120vw] h-[120vw] md:w-[45vw] md:h-[45vw]">
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at center, rgba(59, 130, 246, 0.20) 0%, rgba(59, 130, 246, 0.10) 40%, transparent 70%)",
              }}
            />
          </div>
          ...
          <div className="absolute bottom-[-20%] left-1/2 -translate-x-1/2 translate-y-[20%] md:translate-y-[40%] w-[120vw] h-[120vw] md:w-[55vw] md:h-[55vw]">
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at center, rgba(236, 72, 153, 0.15) 0%, rgba(236, 72, 153, 0.08) 40%, transparent 70%)",
              }}
            />
          </div>
          ...
          <div className="absolute top-[20%] right-[-40%] md:top-[5%] md:right-[-10%] w-[100vw] h-[100vw] md:w-[45vw] md:h-[45vw]">
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at center, rgba(34, 197, 94, 0.15) 0%, rgba(34, 197, 94, 0.08) 40%, transparent 70%)",
              }}
            />
          </div>
        </div>
      ...
      <style>{`
        .dark .blob-1 {
          background: radial-gradient(circle at center, rgba(56, 189, 248, 0.15) 0%, rgba(56, 189, 248, 0.08) 40%, transparent 70%) !important;
        }
        .dark .blob-2 {
          background: radial-gradient(circle at center, rgba(168, 85, 247, 0.15) 0%, rgba(168, 85, 247, 0.08) 40%, transparent 70%) !important;
        }
        .dark .blob-3 {
          background: radial-gradient(circle at center, rgba(20, 184, 166, 0.15) 0%, rgba(20, 184, 166, 0.08) 40%, transparent 70%) !important;
        }
      `}</style>
    </>
  );
